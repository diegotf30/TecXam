...
export class BaseService {
  ...
  post(url: string, body: any) {
    ...
    if (token) {
      ...
      return this._http.post<ServerResponse>(environment.apiEndpoint + url, body, { withCredentials: true, headers: headers });
    }
    return this._http.post<ServerResponse>(environment.apiEndpoint + url, body, { withCredentials: true });
  }
